...
static int init_sensors_cfg_data_from_dts(void)
{
    ...
    if(is_invensense_exit && sensor_chip_info[GYRO][0] != '\0')
    {
        strncpy(sensor_chip_info[ACC], "huawei,Invensense_icm20628", sizeof(sensor_chip_info[ACC]));
        strncpy(sensor_chip_info[MAG], "huawei,akm-akm09911", sizeof(sensor_chip_info[MAG]));
        //parse acc and mag parameter, fill acc_data and mag_data
    }
