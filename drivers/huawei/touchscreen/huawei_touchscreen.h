...
//	TS_NUM_TOTAL = 12, /* total gesture numbers  */
	TS_DOUBLE_CLICK = 59, /*0.Double tap:KEY_F1*/
	TS_SLIDE_L2R = 60, /*1.Single finger slide from left to right:KEY_F2*/
	TS_SLIDE_R2L = 61, /*2.Single finger slide from right to left:KEY_F3*/
	TS_SLIDE_T2B = 62, /*3.Single finger slide from top to bottom:KEY_F4*/
	TS_SLIDE_B2T = 63, /*4.Single finger slide from bottom to top:KEY_F5*/
	TS_CIRCLE_SLIDE = 64, /*5.Single finger slide circle:KEY_F7*/
	TS_LETTER_c = 65, /*6.Single finger write letter c*:KEY_F8*/
	TS_LETTER_e = 66, /*7.Single finger write letter e:KEY_F9*/
	TS_LETTER_m = 67, /*8.Single finger write letter m:KEY_F10*/
	TS_LETTER_w = 68, /*9.Single finger write letter w:KEY_F11*/
	TS_PALM_COVERED = 87, /*10.Palm off screen:KEY_F12*/
